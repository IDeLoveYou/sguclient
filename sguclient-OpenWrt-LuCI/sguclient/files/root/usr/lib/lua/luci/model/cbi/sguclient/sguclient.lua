...
password = s:option(Value, "password", translate("1x Password"), translate("Fill in your 802.1x password"))
...
s = m:section(TypedSection, "sguclient", translate("Extra Settings"))
s.addremove = false
s.anonymous = true
